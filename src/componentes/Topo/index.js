			...
			<div className='topo-conteudo'>
				...
				<nav className='topo-links'>
					...
					<div className='menu'>
						...
						<Link className='topo-link' to='/Estacionamentos-Parceiros'>
						...
						{authenticated ? (
							<span className='topo-link' onClick={handleLogout}>
								Sair
							</span>
						) : (
							<Link className='topo-link' to='/login'>
								Login
							</Link>
						)}
					</div>
